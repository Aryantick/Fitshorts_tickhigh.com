...
async function getReelById(req, res) {
  ...
  try {
    const result = await ReelService.getReelById(id);
...
async function deleteReel(req, res) {
  ...
  try {
    const result = await ReelService.deleteReel(id, userId);
...
async function reelLike(req, res) {
  ...
  try {
    const result = await ReelService.likeReel(reelId, userId);
...
async function unlikeReel(req, res) {
  ...
  try {
    const result = await ReelService.unlikeReel(reelId, userId);
...
async function recordView(req, res) {
  ...
  try {
    const result = await ReelService.recordView(reelId, userId, watchDuration);
...
async function getMyReels(req, res) {
  const userId = req.user.userId;
  try {
    const result = await ReelService.getMyReels(userId);
